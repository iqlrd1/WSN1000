 ...
 * Persistent storage which is used to hold panic code is initialized to zero,
...
typedef enum
{
    ...
    /* Failure while deleting device from white list */
    app_panic_delete_whitelist,

    /* Failure while adding device to white list */
