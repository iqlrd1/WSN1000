...
#define HANDLE_GATT_SERVICE_END         (0x0001)
#define ATTR_LEN_GATT_SERVICE           (2)
#define HANDLE_GAP_SERVICE              (0x0002)
#define HANDLE_GAP_SERVICE_END          (0x0008)
#define ATTR_LEN_GAP_SERVICE            (2)
#define HANDLE_DEVICE_NAME              (0x0004)
#define ATTR_LEN_DEVICE_NAME            (1)
#define HANDLE_DEVICE_APPEARANCE        (0x0006)
#define ATTR_LEN_DEVICE_APPEARANCE      (2)
#define HANDLE_MESH_CONTROL_SERVICE     (0x0009)
#define HANDLE_MESH_CONTROL_SERVICE_END (0xffff)
#define ATTR_LEN_MESH_CONTROL_SERVICE   (2)
#define HANDLE_NETWORK_KEY              (0x000b)
#define ATTR_LEN_NETWORK_KEY            (1)
#define HANDLE_DEVICE_UUID              (0x000d)
#define ATTR_LEN_DEVICE_UUID            (16)
#define HANDLE_DEVICE_ID                (0x000f)
#define ATTR_LEN_DEVICE_ID              (1)
#define HANDLE_MTL_CONTINUATION_CP      (0x0011)
#define ATTR_LEN_MTL_CONTINUATION_CP    (1)
#define HANDLE_MTL_CP_CLIENT_CONFIG     (0x0012)
#define ATTR_LEN_MTL_CP_CLIENT_CONFIG   (0)
#define HANDLE_MTL_COMPLETE_CP          (0x0014)
#define ATTR_LEN_MTL_COMPLETE_CP        (1)
#define HANDLE_MTL_CP2_CLIENT_CONFIG    (0x0015)
#define ATTR_LEN_MTL_CP2_CLIENT_CONFIG  (0)
#define HANDLE_MTL_TTL                  (0x0017)
#define ATTR_LEN_MTL_TTL                (1)
#define HANDLE_MESH_APPEARANCE          (0x0019)
