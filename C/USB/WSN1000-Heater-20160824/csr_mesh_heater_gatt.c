...
static void gattAdvertTimerHandler(timer_id tid)
{
    if (g_heater_app_data.gatt_data.app_tid == tid)
    {
...
extern void GattTriggerFastAdverts(void)
{
    ...
    MemCopy(&adv_params.bd_addr.addr, &g_heater_app_data.random_bd_addr, 
                                                            sizeof(BD_ADDR_T));
                                                ...
                                                & BLE_GATT_SERVER_BEARER_MASK)
    {
        ...
        g_heater_app_data.gatt_data.app_tid = TimerCreate(
                                 g_heater_app_data.gatt_data.advert_timer_value,
